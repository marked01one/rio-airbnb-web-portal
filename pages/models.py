...
@dash.callback(Output("model_category_freq", "figure"), Input("model_freq", "value"))
...
@dash.callback(Output("model_category_impact", "figure"), Input("model_impact", "value"))
def category_types_pie(model_types: str):
    ...
    html.Div(
      ...
      children=[
        ...
        html.Div(
          className='col-12 col-lg-6',
          children=[
            dcc.Graph(id="model_category_freq"),
            html.Div(
              children=[
        ...
        html.Div(
          className='col-12 col-lg-6',
          children=[
            dcc.Graph(id="model_category_impact"),
            html.Div(
              children=[
                html.H5("Model Categories:"),
                dcc.Dropdown(
